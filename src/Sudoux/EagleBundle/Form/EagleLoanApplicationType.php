...
use Sudoux\EagleBundle\Entity\EagleAssetAccount;
...
/**
 * Class EagleLoanApplicationType
 * @package Sudoux\EagleBundle\Form
 * @author Eric Haynes
 */
class EagleLoanApplicationType extends AbstractType
{
     ...
     * @param \Sudoux\EagleBundle\Entity\EagleLoanApplication|null $application
     */
    public function __construct(Site $site, EagleLoanApplication $application = null)
    {
        if(isset($application)) {
            $this->application = $application;
        } else {
            $this->application = new EagleLoanApplication();
        }
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('loan_purpose', 'choice', array(
                'label' => 'Which type of loan are you applying for?',
                'multiple' => false,
                'choices' => $application->loanPurposes,
                'expanded' => true,
                'multiple' => false,
            ))
            ...
            ->add('is_lennar_home', 'choice', array(
                'label' => 'Is this a lennar home?',
                'choices' => array(
                    false => 'No',
                    true => 'Yes',
                ),
            ...
            ->add('lennar_community_name', 'text', array(
                'label' => 'Community Name?',
                'required' => false,
            ))
            ->add('lennar_builder_name', 'text', array(
                'label' => 'Builder Name?',
                'required' => false,
            ))
            ->add('need_to_sell', 'choice', array(
                'required' => false,
                'label' => 'Do you need to sell home?',
                'choices' => array(
                    1 => 'Yes',
                    2 => 'No',
                ),
            ...
            ->add('borrower', new EagleBorrowerType())
            ->add('co_borrower', 'collection', array (
                'type' => new EagleBorrowerType(),
                'allow_add' => true,
                'allow_delete' => true,
                'prototype' => true,
                'by_reference' => false,
            ...
            ->add('asset_account', 'collection', array (
                'type' => new EagleAssetAccountType($this->application->getId()),
                'allow_add' => true,
                'allow_delete' => true,
                'prototype' => true,
                'by_reference' => false,
            ...
            ->add('asset_real_estate', 'collection', array (
                'type' => new EagleAssetRealEstateType($this->application->getId()),
                'allow_add' => true,
                'allow_delete' => true,
                'prototype' => true,
                'by_reference' => false,
            ...
            ->add('income_other', 'collection', array (
                'type' => new EagleIncomeOtherType($this->application->getId()),
                'allow_add' => true,
                'allow_delete' => true,
                'prototype' => true,
                'by_reference' => false,
            ...
            ->add('income_monthly', 'collection', array (
                'type' => new EagleIncomeMonthlyType($this->application->getId()),
                'allow_add' => true,
                'allow_delete' => true,
                'prototype' => true,
                'by_reference' => false,
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Sudoux\EagleBundle\Entity\EagleLoanApplication',
    ...
    {
        return 'sudoux_eaglebundle_EagleLoanApplicationType';
    }
