...
use Sudoux\EagleBundle\Entity\EagleBorrower;
...
class EagleBorrowerType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $borrower = new EagleBorrower();
        ...
        $builder
            ...
            ->add('preferred_contact_time', 'choice', array(
                'required' => false,
                'choices' => $borrower->preferred_contact_times,
                'empty_value' => 'Select a value',
                'attr' => array('class' => 'span3'),
            ))
            ->add('preferred_contact_method', 'choice', array(
                'required' => false,
                'choices' => $borrower->preferred_contact_methods,
                'empty_value' => 'Select a value',
                'attr' => array('class' => 'span3'),
            ))
            ...
            ->add('location', new EagleBorrowerLocationType())
            ->add('previous_location', 'collection', array (
                'type' => new EagleBorrowerLocationType(),
                'allow_add' => true,
                'allow_delete' => true,
                'prototype' => true,
                'by_reference' => false,
            ...
            ->add('citizen_status', 'choice', array(
                'required' => false,
                'choices' => $borrower->citizen_statuses,
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Sudoux\EagleBundle\Entity\EagleBorrower'
        ));
    }

    public function getName()
    {
        return 'sudoux_eaglebundle_EagleBorrowerType';
    }
}
