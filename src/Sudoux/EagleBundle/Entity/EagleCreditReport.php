...
class EagleCreditReport
{
     ...
     * @return EagleCreditReport
     */
    public function addBorrower(\Sudoux\EagleBundle\Entity\EagleBorrower $borrower)
    {
     ...
     * @param \Sudoux\EagleBundle\Entity\EagleBorrower $borrower
     */
    public function removeBorrower(\Sudoux\EagleBundle\Entity\EagleBorrower $borrower)
    {
