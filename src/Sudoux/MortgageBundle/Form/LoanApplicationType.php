...
use Sudoux\MortgageBundle\Entity\BorrowerDeclaration;
...
class LoanApplicationType extends AbstractType
{
     ...
     */
	public function __construct(Site $site, LoanApplication $application = null)
	{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('borrower', new BorrowerType())
            ->add('co_borrower', 'collection', array (
            	'type' => new BorrowerType(),
            	'allow_add' => true,
            	'allow_delete' => true,
            	'prototype' => true,
            	'by_reference' => false,
            ...
            ->add('asset_account', 'collection', array (
            	'type' => new AssetAccountType($this->application->getId()),
            	'allow_add' => true,
            	'allow_delete' => true,
            	'prototype' => true,
            	'by_reference' => false,
            ...
            ->add('asset_real_estate', 'collection', array (
            	'type' => new AssetRealEstateType($this->application->getId()),
            	'allow_add' => true,
            	'allow_delete' => true,
            	'prototype' => true,
            	'by_reference' => false,
            ...
            ->add('income_other', 'collection', array (
            	'type' => new IncomeOtherType($this->application->getId()),
            	'allow_add' => true,
            	'allow_delete' => true,
            	'prototype' => true,
            	'by_reference' => false,
            ...
            ->add('income_monthly', 'collection', array (
            	'type' => new IncomeMonthlyType($this->application->getId()),
            	'allow_add' => true,
            	'allow_delete' => true,
            	'prototype' => true,
            	'by_reference' => false,
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Sudoux\MortgageBundle\Entity\LoanApplication',
    ...
    {
        return 'sudoux_mortgagebundle_loanapplicationtype';
    }
}
