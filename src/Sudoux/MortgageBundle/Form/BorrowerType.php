...
class BorrowerType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('location', new BorrowerLocationType())
            ->add('previous_location', 'collection', array (
            	'type' => new BorrowerLocationType(),
            	'allow_add' => true,
            	'allow_delete' => true,
            	'prototype' => true,
            	'by_reference' => false,
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Sudoux\MortgageBundle\Entity\Borrower',
        ));
    }

    public function getName()
    {
        return 'sudoux_mortgagebundle_borrowertype';
    }
}
